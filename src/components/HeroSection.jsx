export default function HeroSection() {
  return (
    <section className="bg-gradient-to-br from-earth-50 via-white to-accent-purple/5 h-[700px] flex items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center px-4 py-2 bg-accent-purple/10 rounded-full">
                ...
                <span className="text-accent-purple font-medium text-sm">Empowering African Women in Tech</span>
              </div>
              ...
              <p className="text-xl text-earth-600 leading-relaxed">
                Connect with scholarships, internships, and grants designed specifically for young women in tech across
                Africa. Build your future with personalized opportunities and expert guidance.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-gradient-to-r from-accent-purple to-accent-teal text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                Start Your Journey
              <FaArrowRight className="ml-2 inline" />
              </button>
              <button className="border-2 border-earth-300 text-earth-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-accent-purple hover:text-accent-purple transition-all">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl p-8">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-earth-600 font-medium">Next Deadline</span>
                  <span className="text-accent-coral font-bold">3 days left</span>
                </div>
                <div className="bg-earth-50 rounded-lg p-4">
                  <h3 className="font-semibold text-earth-900">Google Women Techmakers Scholarship</h3>
                  <p className="text-sm text-earth-600 mt-1">Full tuition + mentorship program</p>
                </div>
              </div>
            </div>
          </div>
